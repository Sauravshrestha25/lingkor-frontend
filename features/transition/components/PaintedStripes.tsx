...
export const PaintedStripes = forwardRef<
  HTMLDivElement,
  { className?: string }
>(function PaintedStripes({ className = "" }, ref) {
  return (
    <div
      ref={ref}
      className={`fixed inset-0 z-[99999] pointer-events-auto overflow-hidden ${className}`}
      aria-hidden="true"
    >
      {/* Organic Plaster & Mineral Grain SVG Filter Definition */}
      <svg className="absolute w-0 h-0 pointer-events-none">
        <defs>
          <filter id="mineral-plaster-grain">
            <feTurbulence
              type="fractalNoise"
              baseFrequency="0.75"
              numOctaves="3"
      ...
      {/* 4 Vertical Painted Columns */}
      <div className="relative w-full h-full flex">
        {/* Column 1: Slate Indigo / Weathered Charcoal (22%) */}
        <div
          className="paint-column paint-col-1 relative h-full w-[22%] -translate-y-full will-change-transform overflow-hidden shadow-[2px_0_15px_rgba(0,0,0,0.3)]"
          style={{
            background:
              "linear-gradient(180deg, #383f46 0%, #2b3238 50%, #1f2429 100%)",
          }}
        >
          {/* Vertical wash & streaks */}
          <div
          ...
          {/* Plaster Grain */}
          <div
            className="absolute inset-0 opacity-40 mix-blend-hard-light pointer-events-none"
            style={{ filter: "url(#mineral-plaster-grain)" }}
          />
          {/* Brush Bristles Bottom Edge Accent */}
          <div
            className="absolute -bottom-10 inset-x-0 h-10 pointer-events-none opacity-80"
            style={{
              background:
                "linear-gradient(180deg, #1f2429 0%, rgba(31,36,41,0.6) 60%, transparent 100%)",
              clipPath:
                "polygon(0% 0%, 15% 70%, 30% 30%, 48% 90%, 65% 40%, 82% 85%, 100% 0%)",
            }}
          />
        </div>

        {/* Column 2: Himalayan Cinnabar / Terracotta Red (27%) */}
        <div
          className="paint-column paint-col-2 relative h-full w-[27%] -translate-y-full will-change-transform overflow-hidden shadow-[2px_0_18px_rgba(0,0,0,0.35)]"
          style={{
            background:
              "linear-gradient(180deg, #ad4a33 0%, #9a3d28 50%, #822e1c 100%)",
          }}
        >
          <div
            className="absolute inset-0 opacity-35 mix-blend-color-burn"
            style={{
              background:
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, #822e1c 0%, rgba(130,46,28,0.6) 60%, transparent 100%)",
              clipPath:
                "polygon(0% 0%, 12% 85%, 28% 40%, 45% 95%, 68% 30%, 85% 75%, 100% 0%)",
            }}
          />
        </div>

        {/* Column 3: Mustang Golden Ochre / Himalayan Gold (28%) */}
        <div
          className="paint-column paint-col-3 relative h-full w-[28%] -translate-y-full will-change-transform overflow-hidden shadow-[2px_0_20px_rgba(0,0,0,0.4)]"
          style={{
            background:
              "linear-gradient(180deg, #e4a648 0%, #d59238 50%, #ba7622 100%)",
          }}
        >
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 50% 50%, rgba(255,255,255,0.65) 0%, transparent 75%)",
            }}
          />
          <div
            className="absolute inset-0 opacity-40 mix-blend-hard-light pointer-events-none"
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, #ba7622 0%, rgba(186,118,34,0.6) 60%, transparent 100%)",
              clipPath:
                "polygon(0% 0%, 18% 60%, 35% 90%, 55% 35%, 72% 85%, 90% 45%, 100% 0%)",
            }}
          />
        </div>

        {/* Column 4: Deep Rust / Terracotta (23%) */}
        <div
          className="paint-column paint-col-4 relative h-full w-[23%] -translate-y-full will-change-transform overflow-hidden shadow-[2px_0_15px_rgba(0,0,0,0.3)]"
          style={{
            background:
              "linear-gradient(180deg, #a84630 0%, #913521 50%, #782614 100%)",
          }}
        >
          <div
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(180deg, #782614 0%, rgba(120,38,20,0.6) 60%, transparent 100%)",
              clipPath:
                "polygon(0% 0%, 10% 75%, 25% 30%, 42% 90%, 60% 45%, 80% 80%, 100% 0%)",
            }}
          />
        </div>
      </div>

      {/* Center White Embossed Lingkor Logo Reveal */}
      <div className="paint-logo-container absolute inset-0 flex flex-col items-center justify-center pointer-events-none opacity-0 z-20">
        <div className="w-52 sm:w-64 md:w-80 px-4 filter drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)] drop-shadow-[0_12px_24px_rgba(0,0,0,0.4)]">
          <svg
